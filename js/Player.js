...
//            this.sprite.scale.y = 2;
            ...
            this.fireSound = this.game.add.audio('laserCannon');
...
//            this.damages = [];
    ...
    update: function () {
        ...
        if (this.game.physics.arcade.distanceToXY(this.sprite, this.posOffsetX, this.sprite.y) < 10) {
            this.sprite.body.velocity.x = 0;
        }
        else if (this.posOffsetX > this.sprite.x)
